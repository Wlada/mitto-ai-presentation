...
// a typed RESULTS module that slide-08-results imports. Run after `npm run
...
const targetPath = join(repoRoot, 'apps/web/src/app/slides/slide-08-results/results.data.ts');
