...
Commands                              Results
  ...
  npm run e2e      # 4 functional      16 e2e (4 functional + 12 visual)
                     + 12 visual
                     regression
...
`apps/web/src/app/slides/slide-08-results/results.data.ts`, regenerated by
...
- **Time check at slide 9.** If past 26 min, skip slide 11 (Team model) and go straight to slide 12 (Conclusion).
